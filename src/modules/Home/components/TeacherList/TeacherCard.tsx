...
const TeacherCard: FunctionComponent<TeacherCArdProps> = ({onClickOnTeacherCall, teacher: { rating, hasDiploma, description, avatar, name }}) => {
        ...
        <header className={'p-2 flex flex-col'}>
            ...
            <div className={'mt-3'}>
                ...
                <div className={'flex justify-end mt-2'}>
                    <button onClick={onClickOnTeacherCall} className={'transition-all rounded uppercase p-2 font-medium bg-green-400 text-white text-sm hover:bg-green-600'}>Appel</button>
                </div>
            </div>
        </header>
    </div>
